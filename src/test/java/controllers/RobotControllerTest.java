...
class RobotControllerTest {
    ...
    @BeforeEach
    void setUp() {
        robot = new Robot(new Position(0,0, 0));
    ...
    public void shouldMoveTheRobotLeftNTimes(){
        ...
        Assertions.assertEquals(new Position(-2, 0, 0), robot.getCurrentPosition());
    }
    ...
    public void shouldMoveTheRobotRightNTimes(){
        ...
        Assertions.assertEquals(new Position(3, 0, 0), robot.getCurrentPosition());
    }
    ...
    public void shouldMoveTheRobotUpNTimes(){
        ...
        Assertions.assertEquals(new Position(0, 3, 0), robot.getCurrentPosition());
    }
    ...
    public void shouldGetTheInitialPositionOfRobot(){
        ...
        Assertions.assertEquals(new Position(0,0, 0), robot.getInitialPosition());
    }
